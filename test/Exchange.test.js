  ...
  let feePercent = 10
    ...
    describe('making orders', async () => {
    	...
    	it('tracks the newly created order', async () => {
    		...
    		order.amountGive.toString().should.equal(ether(1).toString(), 'amouuntGive is correct')
    	...
    	it('emits an "Order" event', async () => {
    		...
    		event.amountGive.toString().should.equal(ether(1).toString(), 'amouuntGive is correct')
    ...
    describe('order actions', async () => {
    	...
    	// user1 makes order to buy tokens w/ ether	
